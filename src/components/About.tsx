...
const About = () => {
    return (
        <div className="w-full bg-blue-100 flex flex-col items-center justify-between pt-20" id="sectionA">
            <div className="flex flex-col md:flex-row md:justify-evenly items-center w-full pb-10">
            ...
            <Image className="pointer-events-none w-full min-w-max inset-0" src={blue_waves_bottom} alt="Vijoh Light Logo" />
