...
const Header = () => {
  return (
    <div className="w-full bg-primary-light dark:bg-primary-dark flex flex-col items-center justify-between">
        <div className="flex items-center md:justify-evenly md:max-w-[60rem] flex-col md:flex-row w-full mt-5 sm:mt-12 pb-10 ">
      ...
      <Image className="pointer-events-none w-full min-w-max scale-150 sm:scale-125 md:scale-110" src={blue_waves_top} alt="Vijoh Light Logo" />
    </div>
  );
};
