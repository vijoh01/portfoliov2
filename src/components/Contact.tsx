...
const Contact = () => {
    ...
    return (
        <div className="w-full bg-primary-light text-primary-dark flex flex-col items-center " id="sectionD">
      
          
                <form className='flex flex-col w-full sm:w-[40rem] px-5 mb-16'>
                <h1 className="text-4xl w-full">Connect With Me</h1>
                <p className="my-4 text-lg">I'm thrilled that you've made it to this part of my portfolio. Whether you have a project in mind, a question to ask, or just want to say hi, I'm all ears (virtually speaking, of course). Your thoughts and ideas matter to me.</p>
            ...
            <Image className="pointer-events-none w-full min-w-max inset-0" src={black_wave_footer} alt="Vijoh Light Logo" />
        </div>
    );
};
